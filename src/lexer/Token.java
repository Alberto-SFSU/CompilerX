 ...
 *  @param lineNum is the line number of the source file where the Token is found 
*/
  public Token(int leftPosition, int rightPosition, int lineNum, Symbol sym) { //added line number
